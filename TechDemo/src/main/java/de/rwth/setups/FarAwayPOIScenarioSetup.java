...
public class FarAwayPOIScenarioSetup extends DefaultARSetup {
	...
	public void _a_initFieldsIfNecessary() {
		...
		radar = new RadarView(getActivity(), (int) (getScreenWidth() / 3), getCamera(), getWorld().getAllItems());
	}

	@Override
	public void addObjectsTo(GL1Renderer renderer, World world, final GLFactory objectFactory) {
		GeoObj o = new GeoObj();
	...
	public void _e2_addElementsToGuiSetup(GuiSetup guiSetup, Activity activity) {
		...
		guiSetup.addButtonToBottomView(new Command() {
			...
			public boolean execute() {
				...
				CommandShowToast.show(getActivity(), "altitude=" + getCamera().getGPSPositionVec().z);
		...
		guiSetup.addButtonToBottomView(new Command() {
			...
			public boolean execute() {
				...
				o.setOnClickCommand(new Command() {
					...
					@Override
					public boolean execute() {
						CommandShowToast.show(getActivity(), "o.getAltitude()=" + o.getAltitude());
						return true;
					}
				});
