...
public class Vec {
    ...
    /**
     * To get the point 10 meters away 30 degree counterclockwise from north you just
     * have to pass (10, 30) as parameters
     *
     * @param distanceInMeters distance in meters to the user
     * @param angleInDegree    COUNTERCLOCKWISE rotation angle
     * @return rotated Vec
     */
    public static Vec rotatedVecInXYPlaneNorthCounterClockwise(float distanceInMeters,
                                                               double angleInDegree) {
        Vec v = new Vec(0, distanceInMeters, 0);
     ...
     * @return rotated Vec
     */
    public static Vec rotatedVecInXYPlaneNorthClockwise(float distanceInMeters,
                                                        double angleInDegree) {
        Vec v = new Vec(0, distanceInMeters, 0);
        v.rotateAroundZAxis(-angleInDegree);
        return v;
    ...
    /**
     * To get the point 10 meters away 30 degree counterclockwise from south you just
     * have to pass (10, 30) as parameters
     *
     * @param distanceInMeters distance in meters to the user
     * @param angleInDegree    COUNTERCLOCKWISE rotation angle
     * @return rotated Vec
     */
    public static Vec rotatedVecInXYPlaneSouthCounterClockwise(float distanceInMeters,
                                                               double angleInDegree) {
    ...
    /**
     * To get the point 10 meters away 30 degree clockwise from south you just
     * have to pass (10, 30) as parameters
     *
     * @param distanceInMeters distance in meters to the user
     * @param angleInDegree    CLOCKWISE rotation angle
     * @return rotated Vec
     */
    public static Vec rotatedVecInXYPlaneSouthClockwise(float distanceInMeters,
                                                        double angleInDegree) {
        Vec v = new Vec(distanceInMeters, 0, 0);
        v.rotateAroundZAxis(-angleInDegree);
        return v;
