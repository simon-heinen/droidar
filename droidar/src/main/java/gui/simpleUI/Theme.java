...
public class Theme implements EditItem {
    ...
    public static class ThemeColors {
        ...
        public static Theme.ThemeColors initToGray() {
            Theme.ThemeColors c = new ThemeColors();
            int[] colorArray = new int[2];
            colorArray[0] = ThemeColors.grayB;
            colorArray[1] = ThemeColors.grayD;
            c.applyToAllTextColors(ThemeColors.blackT2);
            c.applyToImportantBackgrounds(colorArray);
            c.applyToAllShadows(Color.GRAY);
            return c;
        }

        public static Theme.ThemeColors initToWhite() {
            Theme.ThemeColors c = new ThemeColors();
            int[] colorArray = new int[2];
            colorArray[0] = ThemeColors.whiteB;
            colorArray[1] = ThemeColors.whiteD;
            c.applyToAllTextColors(ThemeColors.blackT2);
            c.applyToImportantBackgrounds(colorArray);
            c.applyToAllShadows(Color.BLACK);
            return c;
        }
