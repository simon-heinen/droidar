...
public class Headline extends AbstractModifier {
    ...
    public Headline(int iconId, String text, float manualTextSize, int textColor) {
        this(iconId, text);
        myTextSize = manualTextSize;
        myTextColor = textColor;
    }

	public Headline(int iconId, String text, float manualTextSize, int backgroundColor, int textColor) {
		this(iconId, text);
		myTextSize = manualTextSize;
		myColor = backgroundColor;
		myTextColor = textColor;
